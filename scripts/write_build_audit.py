...
def main():
    ...
    visual_path = ROOT / 'audit/visual_review_20260921.json'
    ...
    payload = {
        ...
        'release': 'v0.5.0', 'status': 'HEP/computational-physics pilot-checkpoint validation preprint',
        'claim': 'Decoder-level numerical validity and percent-level agreement in selected inclusive response and occupancy observables coexist with substantially more fragmented longitudinal and readout-graph shower support on the specified development bank.',
    ...
    text = ('# Final manuscript build audit\n\nVersion 0.5.0; '+payload['created_utc']+'.\n\n'
            ...
            +'The supported claim is that decoder-level validity and close selected inclusive response and occupancy means coexist with fragmented longitudinal and readout-graph shower support in the specified pilot checkpoint. '
            +'This build audit establishes document consistency and rendering checks, not physics fidelity or submission approval. '
